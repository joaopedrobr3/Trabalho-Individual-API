...
@Autowired
    ...
    @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "pessoa encontrado", content = @Content),
    @ApiResponse(responseCode = "404", description = "pessoa não encontrado com o ID informado", content = @Content)
    })
    ...
    @ApiResponses(value = {
    @ApiResponse(responseCode = "201", description = "pessoa cadastrado com sucesso", content = @Content),
    @ApiResponse(responseCode = "400", description = "Dados inválidos ou campos obrigatórios vazios", content = @Content),
    @ApiResponse(responseCode = "409", description = "pessoa já cadastrado no sistema", content = @Content)
})
    ...
    @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "pessoa atualizado com sucesso", content = @Content),
    @ApiResponse(responseCode = "400", description = "Dados inválidos ou campos obrigatórios vazios", content = @Content),
    @ApiResponse(responseCode = "404", description = "pessoa não encontrado com o ID informado", content = @Content)
})
    ...
    @ApiResponses(value = {
    @ApiResponse(responseCode = "204", description = "pessoa removido com sucesso", content = @Content),
    @ApiResponse(responseCode = "404", description = "pessoa não encontrado com o ID informado", content = @Content)
})
